...
def test_model_initialization():
    ...
    try:
        ...
        model = PPOCADModel(model_name="Qwen/Qwen2.5-Coder-7B", use_lora=False)
        ...
        ref_model = ReferenceModel(model_name="Qwen/Qwen2.5-Coder-7B")
...
def test_forward_pass():
    ...
    try:
        ...
        model = PPOCADModel(model_name="Qwen/Qwen2.5-Coder-7B", use_lora=False).to(device)
...
def test_reference_model():
    ...
    try:
        ...
        # Initialize models
        policy_model = PPOCADModel(model_name="Qwen/Qwen2.5-Coder-7B", use_lora=False).to(device)
        ref_model = ReferenceModel(model_name="Qwen/Qwen2.5-Coder-7B").to(device)
